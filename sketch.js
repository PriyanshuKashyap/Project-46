...
function serve() {
  ...
  //fill("gold");
  text("Your score and game status will be recorded in the end game state and the console,", 0, 230);
  text("Your score will be recorded in the beginning, the end game state, and the console, and", 0, 250);
